  ...
  return (
    <main className='flex'>
      ...
      <section className='flex left-section'>
        ...
        <button onClick={() => { handleClick("react") }} className={currentActive === "react" ? "active" : null}>React & Express</button>
            ...
            return (
              <motion.article
                ...
                <div style={{ width: "266px" }} className='box'>
                  ...
                  <p className='sub-title'>Lorem ipsum dolor sit amet consectetur elit adipisicing. Ex tempore dolor in, accusantium laudantium accusamus.</p>
